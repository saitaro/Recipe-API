...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Beijing Roasted Duck')
        tag1 = sample_tag(user=self.user, name='Vegetarian')
        tag2 = sample_tag(user=self.user, name='Chinese cuisine')
    ...
    def test_recipe_filtering_by_ingredients(self):
        """Test returning recipes with certain ingredient tags."""
        recipe1 = sample_recipe(user=self.user, title='Thai vegetable curry')
        recipe2 = sample_recipe(user=self.user, title='Beijing Roasted Duck')
        ingredient1 = sample_ingredient(user=self.user, name='Curry')
        ingredient2 = sample_ingredient(user=self.user, name='Duck')
        recipe1.ingredients.add(ingredient1)
        recipe2.ingredients.add(ingredient2)
        recipe3 = sample_recipe(user=self.user, title='Dumplings')
